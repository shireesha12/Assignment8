...
var createSlideshow = function () {
    ...
    var timer, play = true, nodes, img, stopSlideShow, displayNextImage, setPlayText, speed = 2000, speedp;
    ...
    return {
        ...
        interval: function () {
			return function () {
				if (speed) {
                    speed = parseInt(window.prompt("current speed is: " + speed + "! Do you want to change it"), 10);
					if (speed < 0 || isNaN(speed)) {
						window.alert("Please enter non-negative integer");
						speed = speedp;
					} else {
					$("play_pause").value = "Resume";
					stopSlideShow();
					play = false;
					}
			}
